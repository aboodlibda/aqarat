...
{{--                                    <img src="{{asset($product->images[1]->url)}}" alt="" class="c_image_2 tr_all">--}}
                                ...
                                <figcaption class="t_align_c">
                                    <ul>
                                        ...
                                        <li class="m_bottom_7"><a href="#" class="color_light sc_hover fw_light d_inline">{{$product->city->name}}</a></li>
                                        <li class="m_bottom_16"><b class="fs_large second_font scheme_color"> ريال {{$product->price}}</b></li>
                                    </ul>
                                </figcaption>
                            </figure>
                        </div>
