...
<head>
    ...
    <link href="{{asset('front/assets/plugins/bootstrap-rtl-master/dist/css/bootstrap-rtl.min.css')}}" rel="stylesheet">
    <link href="{{asset('front/assets/plugins/bootstrap-select/css/bootstrap-select.min.css')}}" rel="stylesheet">

    <link href="{{asset('front/assets/plugins/fontawesome/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('front/assets/plugins/prettyphoto/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href="{{asset('front/assets/plugins/owl-carousel2/assets/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{asset('front/assets/plugins/owl-carousel2/assets/owl.theme.default.min.css')}}" rel="stylesheet">
    <link href="{{asset('front/assets/plugins/animate/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('front/assets/plugins/swiper/css/swiper.min.css')}}" rel="stylesheet">
    ...
    <!-- Head Libs -->
    <script src="{{asset('front/assets/plugins/modernizr.custom.js')}}"></script>

    <!--[if lt IE 9]>
    <script src="{{asset('front/assets/plugins/iesupport/html5shiv.js')}}"></script>
    <script src="{{asset('front/assets/plugins/iesupport/respond.min.js')}}"></script>
    <![endif]-->
</head>
...
{{--            <div class="loader-logo"> <img src="{{asset('front/assets/img/loader-logo.png')}}" alt=""> </div>--}}
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <ul class="nav sf-menu">
                                        <li><a href="listing.html">الرئيسية</a></li>
                                        <li><a href="listing.html">من نحن</a></li>
                    ...
                    <div class="col-md-2 no-padding top-logo">
                        <div class="logo">
                            <a href="index.html"><img src="{{asset('front/assets/img/logo-reestate.png')}}" alt="Real Estate"/></a>
                        </div>
                    </div>
                    <!-- /Logo -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="thumbnail no-border no-padding thumbnail-property-card">
                                            <div class="media">
                                                ...
                                                <a class="media-link" data-gal="prettyPhoto" href="{{asset('front/assets/img/preview/property/featured-1200x800x1.jpg')}}">
                                                    <img src="{{asset('front/assets/img/preview/property/featured-370x220x1.jpg')}}" alt=""/>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="thumbnail no-border no-padding thumbnail-property-card">
                                            <div class="media">
                                                ...
                                                <a class="media-link" data-gal="prettyPhoto" href="{{asset('front/assets/img/preview/property/featured-1200x800x2.jpg')}}">
                                                    <img src="{{asset('front/assets/img/preview/property/featured-370x220x2.jpg')}}" alt=""/>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="thumbnail no-border no-padding thumbnail-property-card">
                                            <div class="media">
                                                ...
                                                <a class="media-link" data-gal="prettyPhoto" href="{{asset('front/assets/img/preview/property/featured-1200x800x3.jpg')}}">
                                                    <img src="{{asset('front/assets/img/preview/property/featured-370x220x3.jpg')}}" alt=""/>
                                                    <span class="icon-view"><strong><i class="fa fa-arrows-alt"></i></strong></span>
                                                </a>
                                            </div>
                                            <div class="caption text-center">
                                        ...
                                        <div class="thumbnail no-border no-padding thumbnail-property-card">
                                            <div class="media">
                                                ...
                                                <a class="media-link" data-gal="prettyPhoto" href="assets/img/preview/property/featured-1200x800x4.jpg">
                                                    <img src="{{asset('front/assets/img/preview/property/featured-370x220x4.jpg')}}" alt=""/>
                                                    <span class="icon-view"><strong><i class="fa fa-arrows-alt"></i></strong></span>
                                                </a>
                                            </div>
                                            <div class="caption text-center">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="swiper-container" id="swiperSlider1x1">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                                                                    <a class="btn btn-zoom" href="{{asset('front/assets/img/preview/property/cat1-1200x800x1.jpg')}}" data-gal="prettyPhoto"><i class="fa fa-arrows-alt"></i></a>
                                                                    <a href="{{asset('front/assets/img/preview/property/cat1-70x70x1.jpg')}}" data-gal="prettyPhoto"><img class="img-responsive" src="assets/img/preview/property/cat1-600x450x1.jpg" alt=""/></a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="btn btn-zoom" href="{{asset('front/assets/img/preview/property/cat1-1200x800x2.jpg')}}" data-gal="prettyPhoto"><i class="fa fa-arrows-alt"></i></a>
                                                                    <a href="{{asset('front/assets/img/preview/property/cat1-1200x800x2.jpg')}}" data-gal="prettyPhoto"><img class="img-responsive" src="assets/img/preview/property/cat1-600x450x2.jpg" alt=""/></a>
                                                                </div>
                                                                <div class="swiper-slide">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft" data-wow-offset="200" data-wow-delay="100ms">
                        ...
                        <p class="btn-row">
                            <a href="#" class="btn btn-theme ripple-effect btn-theme-md"><i class="fa fa-chevron-left">&nbsp;</i> Read more about us</a>
                        </p>
                    </div>
                    ...
                    <div class="owl-carousel" id="testimonials">
                        <div class="testimonial">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object testimonial-avatar" src="{{asset('front/assets/img/preview/avatars/avatar-1.png')}}" alt="Testimonial avatar">
                                    </a>
                                </div>
                        ...
                        <div class="testimonial">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object testimonial-avatar" src="{{asset('front/assets/img/preview/avatars/avatar-2.png')}}" alt="Testimonial avatar">
                                    </a>
                                </div>
                                <div class="media-body">
                                    <div class="testimonial-text">Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia.</div>
                        ...
                        <div class="testimonial">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object testimonial-avatar" src="{{asset('front/assets/img/preview/avatars/avatar-3.png')}}" alt="Testimonial avatar">
                                    </a>
                                </div>
                                <div class="media-body">
                                    <div class="testimonial-text">Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia.</div>
                        ...
                        <div class="recent-post alt">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <br />
                                    <a href="#" class="btn btn-theme"><i class="fa fa-chevron-left">&nbsp;</i> Continue reading</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft" data-wow-offset="200" data-wow-delay="200ms">
                        ...
                        <!-- Get in touch -->
                        <h2 class="section-title wow fadeInDown text-right" data-wow-offset="200" data-wow-delay="100ms">
...
<!-- JS Global -->
<script src="{{asset('front/assets/plugins/jquery/jquery-1.11.1.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/bootstrap-select/js/bootstrap-select.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/superfish/js/superfish.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/prettyphoto/js/jquery.prettyPhoto.js')}}"></script>
<script src="{{asset('front/assets/plugins/owl-carousel2/owl.carousel.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/jquery.sticky.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/jquery.easing.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/jquery.smoothscroll.min.js')}}"></script>
...
<script src="{{asset('front/assets/plugins/swiper/js/swiper.jquery.min.js')}}"></script>
<script src="{{asset('front/assets/plugins/datetimepicker/js/moment-with-locales.min.js')}}"></script>

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="{{asset('front/assets/plugins/jquery.cookie.js')}}"></script>
<!--<![endif]-->
