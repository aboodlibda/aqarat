                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                @forelse($orders as $order)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span  class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$order->first_name}} {{ $order->last_name}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="symbol symbol-70px me-5  justify-content-center ">
                                                <img src="{{asset('product-images/'.$order->product->image)}}" class="" alt="">
                                        ...
                                        <td>
                                            <span class="badge badge-primary mb-1 fs-7">$  {{$order->product->price}}</span>
                                        </td>
                                        <td >
                                            <a href="{{route('orders.show',$order)}}" class="badge badge-primary mb-1 fs-7">
