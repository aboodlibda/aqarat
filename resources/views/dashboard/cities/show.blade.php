...
@section('content')
    ...
    <div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
        <div class="container">
            ...
            <span class="color_light">{{$city->name}}</span>
        </div>
    </div>
    <!--main content-->
        ...
        <div class="container">
            <div class="row">
                <main class="col-lg-12 col-md-12 col-sm-12 m_bottom_30 m_xs_bottom_10">
                    <h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">{{$city->name}}</h2>
                    <figure class="m_bottom_45 m_xs_bottom_30">
                        <img src="{{asset('cities-images/' . $city->image)}}" alt="" class="m_bottom_15" style="object-fit: cover;height: 500px;width: 1500px">
                    </figure>
                    <!--isotope-->
                    <div id="can_change_layout" class="category_isotope_container three_columns wrapper m_bottom_10 m_xs_bottom_0" data-isotope-options='{
                        ...
                        @foreach($city->product as $product)
                            <!--isotope item-->
                                    ...
                                    <figcaption class="bg_white relative p_bottom_0">
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 m_bottom_9">
                                                ...
                                                <div class="relative">
                                                    <a href="#" class="fw_light color_light sc_hover category_link tr_all">{{$city->name}}</a><br class="d_none">
                                                </div>
