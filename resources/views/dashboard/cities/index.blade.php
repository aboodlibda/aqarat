        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-1">المدن</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            @if(session()->has('city-updated'))
                ...
                <div id="update" class="alert alert-primary d-flex align-items-center p-5 mb-10">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        ...
                        <!--end::Title-->
                        <!--begin::Content-->
                        <span>تم تعديل بيانات المدينة بنجاح</span>
                        <!--end::Content-->
                    </div>
                    <!--end::Wrapper-->
                    <!--begin::Close-->
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">جميع المدن</span>
                        </h3>
                        <div class="card-toolbar">
                            <a href="{{route('cities.create')}}" class="btn btn-sm btn-light-primary">
                                ...
                                <!--end::Svg Icon-->إضافة مدينة جديد</a>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 rounded-start">المدينة</th>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-5">
                                                <img src="{{asset('cities-images/'.$city->image)}}" class="" alt="">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge badge-primary mb-1 fs-7">{{$city->name}}</span>
                                    </td>
                                    <td >
                                        <a href="{{route('cities.edit',$city)}}" class="btn btn-icon btn-bg-light btn-active-color-primary ">
                                        ...
                                        <button type="button"  data-bs-toggle="modal" data-bs-target="#kt_modal_1"  data-id="{{ $city->id }}"  class="btn btn-icon btn-bg-light btn-active-color-danger ">
