        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-1">إضافة مدينة جديدة</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">إضافة مدينة جديدة</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-body p-10">
                        ...
                        @if(session()->has('city-created'))
                            <div class="alert alert-success d-flex align-items-center p-5 mb-10">
                                ...
                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Content-->
                                    <span>تم إضافة مدينة جديدة بنجاح</span>
                                    <!--end::Content-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Close-->
                        ...
                        <!--end::Alert-->
                                ...
                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                    <!--begin:Form-->
                                    <form id="kt_modal_new_target_form" class="form" method="POST" action="{{route('cities.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    <!--begin::Heading-->
                                        <div class="mb-13 text-center">
                                            <!--begin::Title-->
                                            <h1 class="mb-3">أدخل بيانات المدينة</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
...
{{--                                                                </span>--}}
                                           ...
                                           <div class="col-md-9 mb-10">
                                               ...
                                               <!--end::Label-->
                                               <input type="text" class="form-control form-control-solid" placeholder="أدخل اسم المدينة" name="name" value="{{old('name')}}" />
                                               <span class="text-danger">
                                                @error('name')
                                                   {{$message}}
                                                   @enderror
