        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-1">العقارات</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">العقارات</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <!--begin::Alert-->
                    <div id="update" class="alert alert-primary d-flex align-items-center p-5 mb-10">
                        ...
                        <div class="d-flex flex-column pe-0 pe-sm-10">
                            ...
                            <!--end::Title-->
                            <!--begin::Content-->
                            <span>تم تعديل بيانات العقار بنجاح</span>
                            <!--end::Content-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Close-->
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">جميع العقارات</span>
                        </h3>
                        <div class="card-toolbar">
                            <a href="{{route('products.create')}}" class="btn btn-sm btn-light-primary">
                                ...
                                <!--end::Svg Icon-->إضافة عقار جديد</a>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 rounded-start">العقارات</th>
                                ...
                                @forelse($products as $product)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-70px me-5">
                                                    <img src="{{asset($product->images[0]->url)}}" class="" alt="">
                                                </div>
                                        ...
                                        <td>
                                            <span class="badge badge-danger mb-1 fs-7"> {{$product->price}} ريال </span>
                                        </td>
                                        <td>
                                            <span class="badge badge-primary mb-1 fs-7">{{$product->category->name}}</span>
                                        </td>
                                        <td>
                                            <span class="badge badge-info mb-1 fs-7">{{$product->city->name}}</span>
                                        </td>
                                        <td >
