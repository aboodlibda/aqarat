        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-1">تعديل العقار</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">تعديل العقار</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        @if(session()->has('product-updated'))
                            <div class="alert alert-success d-flex align-items-center p-5 mb-10">
                                ...
                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Content-->
                                    <span>تم تعديل العقار بنجاح</span>
                                    <!--end::Content-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Close-->
                    ...
                    <!--end::Alert-->
                        ...
                        <div class="modal-body col-md-12 scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <div class="mb-13 text-center">
                                <!--begin::Title-->
                                <h1 class="mb-3">التعديل على بيانات العقار</h1>
                                <!--end::Title-->
                                <!--begin::Description-->
                                    ...
                                    <div class="col-md-3 mb-10" style="border:1px ">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-225px h-225px"
                                                 style="background-image: url({{asset($product->images[0]->url)}})"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="عنوان العقار" name="name" value="{{$product->name}}"/>
                                                @error('name')
                                                <span class="text-danger">
                                                            {{$message}}
                                                        </span>
                                            ...
                                            <div class="col-md-4 d-flex flex-column mb-8 fv-row">
                                                ...
                                                <input type="number" class="form-control form-control-solid"
                                                       placeholder="سعر العقار" name="price" value="{{$product->price}}"/>
                                                @error('price')
                                                <span class="text-danger">
                                                            {{$message}}
                                                        </span>
                                            ...
                                            <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                                ...
                                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                    ...
                                                    <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                       data-bs-toggle="tooltip"
                                                       title="قم بإدخال وصف العقار الذي سيظهر للمستخدم"></i>
                                                </label>
                                                <!--end::Label-->
