        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-1">إضافة عقار جديد</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('products.index')}}" class="text-muted text-hover-primary">العقارات</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">إضافة عقار جديد</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        @if(session()->has('product-created'))
                            <div class="alert alert-success d-flex align-items-center p-5 mb-10">
                                ...
                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Content-->
                                    <span>تم إضافة عقار جديد بنجاح</span>
                                    <!--end::Content-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Close-->
                                ...
                                <div class="modal-body col-md-12 scroll-y px-10 px-lg-15 pt-0 pb-15">
                                    ...
                                    <!--begin::Heading-->
                                        <div class="mb-13 text-center">
                                            <!--begin::Title-->
                                            <h1 class="mb-3">أدخل بيانات العقار</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-gray-400 fw-bold fs-5">يمكنك تصفح جميع العقارات من
                                            ...
                                            <div class="col-md-9 mb-10" style="border:1px ">
                                                <div class="row">
                                                    <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            ...
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                               ...
                                                               title="قم بإدخال عنوان العقار الذي سيظهر للمستخدم"></i>
                                                        </label>
                                                        <!--end::Label-->
                                                        <input type="text" class="form-control form-control-solid"
                                                               placeholder="عنوان العقار" name="name" value="{{old('name')}}"/>
                                                        @error('name')
                                                        <span class="text-danger">
                                                            {{$message}}
                                                        </span>
                                                    ...
                                                    <div class="col-md-4 d-flex flex-column mb-8 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">سعر العقار</span>
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                               data-bs-toggle="tooltip"
                                                               title="قم بإدخال سعر بيع العقار الذي سيظهر للمستخدم"></i>
                                                        </label>
                                                        <!--end::Label-->
                                                        <input type="number" class="form-control form-control-solid"
                                                               placeholder="سعر العقار" name="price" value="{{old('price')}}"/>
                                                        @error('price')
                                                        <span class="text-danger">
                                                            {{$message}}
                                                        </span>
                                                    ...
                                                    <div class="col-md-4 d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            ...
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                               data-bs-toggle="tooltip"
                                                               title="قم بإختيار الفسم الذي تود اضافة العقار اليه"></i>
                                                        </label>
                                                        <!--end::Label-->
                                                    ...
                                                    <div class="col-md-4 d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            ...
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                               data-bs-toggle="tooltip"
                                                               title="قم بإختيار المدينة التي يتواجد فيها العقار"></i>
                                                        </label>
                                                        <!--end::Label-->
                                                        <select  class="form-control form-control-solid" name="city">
                                                            <option disabled hidden selected>-- إختيار المدينة --</option>
                                                    ...
                                                    <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">وصف العقار</span>
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                               data-bs-toggle="tooltip"
                                                               title="قم بإدخال سعر بيع العقار الذي سيظهر للمستخدم"></i>
                                                        </label>
                                                        ...
                                                        <textarea style="min-height: 100px" class="form-control form-control-solid"
                                                                  placeholder="وصف العقار" name="description">{{value(old('description'))}}</textarea>
                                                        @error('description')
                                                        <span class="text-danger">
                                                            {{$message}}
                                                        </span>
